...
from utilsf import length_normalize, normalize_questions, normalize_vector, calculate_cosine_simil, perf_measure
...
if __name__ == '__main__':
    ...
    for threshold in [0.5, 0.6, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]:
        ...
        result = qm.evaluate_similarity(
            args.question_file, threshold, args.prefix)
